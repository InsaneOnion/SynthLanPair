...
class RendererV3(object):
    ...
    def render_text(self,rgb,depth,seg,area,label,ninstance=1,viz=False):
        ...
        for i in range(ninstance):
            ...
            idict = {'img':[], 'charBB':None, 'wordBB':None, 'txt':None, 'img_':[], 'charBB_':None, 'wordBB_':None, 'txt_':None }
            ...
            for idx in reg_range:
                ...
                try:
                    if self.max_time is None:
                        txt_render_res = self.place_text(img,img_,place_masks[ireg],place_masks_[ireg],
            ...
            if  placed:
                ...
                idict['wordBB_'] = self.char2wordBB(idict['charBB_'].copy(), ' '.join(itext_))
